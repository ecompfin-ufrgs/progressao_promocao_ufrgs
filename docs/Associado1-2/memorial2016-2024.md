...
A seguir, então, apresentamos as atividades de ensino tal como previstas na realizadas [Decisão CONSUN 331/2017](https://www.ufrgs.br/cppd/wp-content/uploads/Dec331-17-Normas-de-progressao-e-promocao-docente-Modificada-outubro-2023.pdf) e as atividades de pesquisa, extensão, administração, representação e outras classificadas segundo a [Resolução DERI 01/2018](https://www.ufrgs.br/cppd/wp-content/uploads/Resolucao_DepEconomiaRela%C3%A7%C3%B5esInternacionais.pdf).


## Atividades de ensino

### item 1.1 - Disciplinas de graduação

Número de disciplinas de 60h - 43 - pontuação = 43 (60/15) = 172

### item 1.2 - Disciplinas de pós-graduação

Número de disciplinas de 45h - 10 - pontuação = 10 x (45/15) = 30

### item 1.4 - Ministrante de curso de extensão

1. Ministrante do I CURSO DE INTRODUÇÃO À PROGRAMAÇÃO PARA PROFISSIONAIS DE NEGÓCIOS - 40h
2. Ministrante do INTRODUÇÃO À PROGRAMAÇÃO EM PYTHON PARA O CONTROLE EXTERNO - 30h

### item 1.6 - Orientação ou coorientação

1. Trabalho de conclusão de curso - 25
2. Estágio não obrigatório - 45
3. Pós-graduação - 3
4. Estágio de docência - 1
...
[I Curso de Introdução à Programação para Profissionais de Negócios](rad-2016-2024.pdf) - 20h

[I Seminário de Cooperação Técnica UFRGS-TCE-RS](rad-2016-2024.pdf) - 8h 

[Introdução à programação em Python para o Controle Externo](rad-2016-2024.pdf) - 40h
...
Duração: 7 dias
Pontuação: número de dias úteis / número de dias do semestre = 7/180.
